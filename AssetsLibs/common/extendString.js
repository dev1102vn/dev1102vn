...
String.prototype.toNumFormat = function () {
    return $.number(this || 0, app.config.Currency.DecimalPlaces, app.config.Currency.ThousandsSeparator, app.config.Currency.DecimalSeparator);
}
